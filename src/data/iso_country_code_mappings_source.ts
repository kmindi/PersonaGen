export const isoCountryCodeMappings = {
    "AD": { name: "Andorra" },
    ...
    "KP": { name: "Korea (the Democratic People's Republic of)" },
    "KR": { name: "Korea (the Republic of)" },
    "KW": { name: "Kuwait" },
    ...
    "TV": { name: "Tuvalu" },
    "TW": { name: "Taiwan, Province of China [note 2]" },
