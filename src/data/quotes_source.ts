export const quotes = [
    ...
    {
        quote:
            "If someone claims to have the perfect programming language, [s]he is either a fool or a salesman or both.",
    ...
    {
        quote:
            "Programming is being ten minutes away from being done for the rest of your life.",
        author: "Jon Maddox"
    },
    {
        quote:
    ...
    {
        quote: "One person's constant is another person's variable.",
    ...
    {
        quote:
            "Never prescribe to poor design what could be more easily explained as half-assed execution.",
        author: "Will Clark"
    },
    {
        quote:
    ...
    {
        quote:
            "To keep large problems well structured, you either need superhuman will power or proper language support for interfaces.",
        author: "Greg Nelson"
    },
    {
